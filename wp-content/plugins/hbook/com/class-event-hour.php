<?php
class Omnivo_Calendar_Event_Hour
{
    ...
    public function GetEvent()
    {
        ...
        {
            $this->event = Omnivo_Calendar_Event::FetchOneById($this->event_id);
        }
        return $this->event;
    }
    ...
    public function GetWeekday()
    {
        ...
        {
            $this->weekday = Omnivo_Calendar_Weekday::FetchOneById($this->weekday_id);
        }
        return $this->weekday;
    }
    ...
    public static function Insert(Omnivo_Calendar_Event_Hour $eventHour)
    {
        global $wpdb;
        $query = '';
        ...
        $query .= "INSERT INTO `" . $wpdb->prefix . "omnivo_calendar_event_hours`
			(" . $queryFieldsClause . ") 
    ...
    public static function Update(Omnivo_Calendar_Event_Hour $eventHour)
    {
        global $wpdb;
        $query = '';
        ...
        $query .= "UPDATE `" . $wpdb->prefix . "omnivo_calendar_event_hours`
			 SET " . $querySetClause . "
